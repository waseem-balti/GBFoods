            ...
            <div class="padd">
              ...
              <form class="form-horizontal" role="form" action="reservation_save.php" method="post">
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-5">
                    <textarea class="form-control" rows="5" placeholder="Complete Address" name="address"
                      required></textarea>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-5">
                    <label class="checkbox-inline">
                      <input type="checkbox" id="inlineCheckbox1" value="option1" required> I agree to the <a
                        href="#facilities" data-toggle="modal">terms and condtion</a> of the GB Foods
                    </label>
                  </div>
                </div>
