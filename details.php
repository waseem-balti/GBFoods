            ...
            <div class="padd">
              ...
              <form class="form-horizontal" role="form" action="details_save.php" method="post">
                <div class="form-group">
                  ...
                  <div class="col-lg-5">
                    <textarea class="form-control" name="venue" rows="5" id="Alton Place"
                      placeholder="Complete Address of venue" required></textarea>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-5">
                    <div id="datetimepicker" class="input-append input-group dtpicker">
                      ...
                      <input data-format="hh:mm A" class="form-control" type="time" name="time" id="datepicker"
                        required="true">
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-5">
                    <select class="form-control select2 " id="exampleSelect1" name="ocassion"
                      placeholder="Select occasion" required>
