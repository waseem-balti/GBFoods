...
<head>
  ...
  <title>Cusine - <?php include('../includes/title.php');?></title>
    ...
    <div class="mainbar">
      ...
      <div class="page-head">
        ...
        <div class="bread-crumb pull-right">
          ...
          <a href="#" class="bread-current">Cusine</a>
        </div>
            ...
            <div class="col-md-12">
              ...
              <div class="widget">
                <div class="widget-head">
                    <a href="#addModal" class="btn btn-info" data-toggle="modal">Add New Cusine</a>
                  </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title">Update Cusine</h4>
            </div>
            <div class="modal-body" style="height:100px">
              ...
              <form class="form-horizontal" method="post" action="category_update.php">
                  ...
                  <div class="form-group">
                      <label class="control-label col-lg-2" for="title">Cusine Name</label>
                      <div class="col-lg-10"> 
...
<div id="delete<?php echo $id;?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
              <h4 class="modal-title">Delete Cusine</h4>
            </div>
            <div class="modal-body" style="height:140px">
              ...
              <form class="form-horizontal" method="post">
                  ...
                  <div class="alert alert-danger">
                      Are you sure you want to delete the Cusine <?php echo $name;?>?
                    </div>                     
                  <!-- Buttons -->
                  <div class="form-group">
                      <!-- Buttons -->
