  ...
  <div class="navbar navbar-fixed-top bs-docs-nav" role="banner">
    ...
    <div class="conjtainer">
      ...
      <div class="navbar-header">
        ...
        <a href="index.html" class="navbar-brand hidden-lg">Online Alton's Management System</a>
      </div>
...
?>
                          <tr>
                            ...
                            <td>
                              ...
                              <a href="#update" class="btn btn-info" data-target="#update<?php echo $id;?>"
                                data-toggle="modal">
                            ...
                            <div class="modal-dialog">
                              <div class="modal-content">
                                ...
                                <div class="modal-body" style="height:300px">
                                  <!--start form-->
                                  <form class="form-horizontal" method="post" action="menu_update.php"
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-lg-8">
                                        <input type="text" class="form-control" name="menu" id="title"
                                          placeholder="Menu Name" value="<?php echo $menu;?>">
                                      </div>
                                    </div>
                                    <!-- Title -->
                                    <div class="form-group">
                              ...
                              $result = mysqli_query($con,"SELECT * FROM category ORDER BY cat_name"); 
                                ...
                                ?>
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-lg-8">
                                        <textarea class="form-control" name="desc" id="title"
                          ...
                          <!-- Modal -->
                          <div id="delete<?php echo $id;?>" class="modal fade" tabindex="-1" role="dialog"
                            aria-labelledby="myModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                              <div class="modal-content">
                                <div class="modal-header">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form class="form-horizontal" method="post" action="menu_save.php" enctype='multipart/form-data'>
            ...
            <!-- Title -->
            <div class="form-group">
              <label class="control-label col-lg-2" for="title">Cusine</label>
              <div class="col-lg-8">
