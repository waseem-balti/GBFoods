...
$query=mysqli_query($con,"select * from reservation left join team on reservation.team_id=team.team_id")or die(mysqli_error($con));
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="height:150px">
              ...
              <form class="form-horizontal" method="post" action="payment_save.php" enctype='multipart/form-data'>
                  ...
                  <div class="col-md-8">
                        <button type="submit" class="btn btn-sm btn-primary" name="update">Save Payment</button>
