  ...
  <div class="navbar navbar-fixed-top bs-docs-nav" role="banner">
    ...
    <div class="conjtainer">
      ...
      <div class="navbar-header">
        ...
        <a href="index.html" class="navbar-brand hidden-lg">GB Foods</a>
      </div>
...
?>
                          <tr>
                            ...
                            <td>
                              <a href="#myModal" class="btn btn-info" data-target="#update<?php echo $id;?>"
                                data-toggle="modal">
                          ...
                          <!-- Modal -->
                          <div id="update<?php echo $id;?>" class="modal fade" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-body" style="height:250px">
                                  ...
                                  <form class="form-horizontal" method="post" action="member_update.php">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-lg-8">
                                        <input type="text" class="form-control" name="last" id="title"
                                          placeholder="Write Last Name" value="<?php echo $last;?>">
                                      </div>
                                    </div>
                                    <!-- Title -->
                                    <div class="form-group">
                                      ...
                                      <div class="col-lg-8">
                                        <input type="text" class="form-control" name="first" id="username"
                                          placeholder="Write First Name" value="<?php echo $first;?>">
                                      </div>
                                    </div>
                                    <!-- Title -->
                                    <div class="form-group">
                                      ...
                                      <div class="col-lg-8">
                                        <input type="text" class="form-control" name="contact" id="password"
                                          placeholder="Write contact number" value="<?php echo $contact;?>">
                                      </div>
                                    </div>
                                    <!-- Title -->
                                    <div class="form-group">
                                      ...
                                      <div class="col-lg-8">
                                        <textarea class="form-control" name="address" id="password"
                                          placeholder="Write complete address"><?php echo $address;?></textarea>
                                      </div>
                                    </div>
        ...
        <div class="modal-body">
          ...
          <form class="form-horizontal" method="post" action="member_save.php">
            ...
            <div class="form-group">
              ...
              <div class="col-lg-8">
                <input type="text" class="form-control" name="first" id="username" placeholder="Write First Name"
                  required>
              </div>
            </div>
            <!-- Title -->
            ...
            <div class="form-group">
              ...
              <div class="col-lg-8">
                <textarea class="form-control" name="address" id="password"
                  placeholder="Write complete address"></textarea>
              </div>
            </div>
